...
export default function ProgramaApoio() {
    return (
        <div className='container' id='programa-apoio'>
            <div className='row'>
                <p className='text-center col mb-5'>
                    ...
                    Basta acessar <a href='https://app.picpay.com/user/podprogramar' target='_blank' rel="noopener noreferrer">picpay.com/user/podprogramar</a>
                </p>
            </div>
        </div>
    );
